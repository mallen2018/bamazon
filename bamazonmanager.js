...
function inquire () {
	...
	},
	{
		...
		type: "input",
		name: "id",
		message: "What is the ID of the robot you want to add to?",
	...
	},
	{
		...
		type: "input",
		name: "name",
		message: "What is the name of the robot you want to add?"
	},
	{
		when: function(answer) {
			return answer.command == "Add New Product";
	...
	},
	{
		...
		type: "input",
		name: "price",
		message: "What is the price of the new robot?",
		validate: function (answer) {
			var input = answer;
			return new Promise ((resolve, reject) => {
				var check = isNaN(input);
	...
	},
	{
		...
		type: "input",
		name: "quantity",
		message: "What is the stock quantity of the new robot?",
		validate: function (answer) {
			var input = answer;
			return new Promise ((resolve, reject) => {
				var check = isNaN(input);
